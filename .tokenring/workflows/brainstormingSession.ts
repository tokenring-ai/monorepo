...
export default {
  ...
  steps: [
    ...
    `/for $pkg in @packages {
      /eval /agent run --type product-design-engineer Search for all the files in $pkg/, understand the current functionality of the package, brainstorm new ideas for improving the package, and save those ideas in a 'brainstorm/prd/{idea_name}.md' file
     }`
  ],
};
