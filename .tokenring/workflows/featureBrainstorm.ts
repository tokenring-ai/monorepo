export default {
  ...
  steps: [
    ...
    `/for $pkg in @packages {
      /eval /agent run product-design-engineer Search for all the files in $pkg/, understand the current functionality of the package, and create or update $pkg/BRAINSTORM.md with brainstormed new features that would enhance this package
     }`
  ]
};
